    ...
    <div className="min-h-screen">
      <div className="lg:container lg:py-6">
        <div className="lg:grid lg:grid-cols-12 lg:gap-6 lg:items-start">
          {/* Broadcast Area */}
          <div className="relative aspect-video max-h-[65vh] bg-muted overflow-hidden lg:col-span-8 xl:col-span-9 lg:max-h-none">
            {viewerState === 'locked' ? (
      ...
      <div className="container py-6 grid grid-cols-1 gap-6">
        {/* Main Column */}

...
import { LEAGUE_REGISTRY, LEAGUE_ID_SET, getLeagueConfig } from '@/lib/leagues';
      ...
      {!teamsQuery.isLoading && activeTab === 'standings' && filteredTeams.length > 0 && (
        <div className="space-y-2 max-w-3xl">
          {standings.map((team, index) => {
            ...
            const leagueId: LeagueId = LEAGUE_ID_SET.has(leagueLower) ? (leagueLower as LeagueId) : 'sbbl';
            return (

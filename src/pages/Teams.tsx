...
import { LEAGUE_REGISTRY, getLeagueConfig, VALID_LEAGUE_IDS } from '@/lib/leagues';
      ...
      {!teamsQuery.isLoading && activeTab === 'standings' && filteredTeams.length > 0 && (
        <div className="space-y-2 max-w-3xl">
          {standings.map((team, index) => {
            ...
            const leagueId: LeagueId = VALID_LEAGUE_IDS.has(leagueLower as LeagueId) ? (leagueLower as LeagueId) : 'sbbl';
            return (

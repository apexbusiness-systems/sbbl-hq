...
import { manualOpsAction } from '@/lib/api/ops';
...
const OpsPage = () => {
  ...
  const [scheduleForm, setScheduleForm] = useState({ leagueId: '', seasonId: '', startsAt: '', endsAt: '', venueId: '' });
  ...
  // Store batch — 4 slots, each: title, price, category

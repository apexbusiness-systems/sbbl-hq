 ...
 *
 * All assets inline — zero network round-trips required for display.
 */
...
export function SplashScreen() {
  ...
  // Track when min display time has elapsed
  useEffect(() => {
    const t = setTimeout(() => {
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: 340,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(201,168,76,0.22) 0%, rgba(249,115,22,0.08) 55%, transparent 80%)',
          pointerEvents: 'none',
        }}
      />
      ...
      <div className="splash-rise" style={{ position: 'relative', marginBottom: 32 }}>
        ...
        {/* App icon — rendered from public asset, instant from cache */}
        <img
          src="/icons/icon.svg"
          alt="SBBL HQ"
          width={160}
      ...
      {/* Thin amber loading bar along the bottom */}
      <div
        style={{
          position: 'absolute',
          bottom: 0,
          ...
          right: 0,
          height: 2,
          background: 'linear-gradient(90deg, transparent, #C9A84C 40%, #f97316 70%, transparent)',
          opacity: exiting ? 0 : 1,

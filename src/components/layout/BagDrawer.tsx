...
// ⚡ Bolt Performance Optimization: Extract expensive hook-based logic into a separate
// conditionally rendered inner component to prevent unnecessary background execution.
const BagDrawerContent = () => {
  ...
  // ⚡ Bolt Performance Optimization: Wrap array reducer in useMemo to prevent O(N) execution overhead on every render

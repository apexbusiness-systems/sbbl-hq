...
export const STATIC_TEAMS: StaticTeam[] = [
  ...
  { name: 'Solid North', leagueId: 'tgifbl', leagueCode: 'TGIFBL', season: 'Season 1' },
  { name: 'OSY x LCL', leagueId: 'tgifbl', leagueCode: 'TGIFBL', season: 'Season 1' },
  { name: 'Batang Riles x Tri J', leagueId: 'tgifbl', leagueCode: 'TGIFBL', season: 'Season 1' },
  { name: 'J Elite', leagueId: 'tgifbl', leagueCode: 'TGIFBL', season: 'Season 1' },
  { name: 'YG', leagueId: 'tgifbl', leagueCode: 'TGIFBL', season: 'Season 1' },
  { name: 'Conceited Fantasy', leagueId: 'tgifbl', leagueCode: 'TGIFBL', season: 'Season 1' },
  { name: 'C&F', leagueId: 'tgifbl', leagueCode: 'TGIFBL', season: 'Season 1' },
  { name: 'City Above Elite', leagueId: 'tgifbl', leagueCode: 'TGIFBL', season: 'Season 1' },
  { name: 'Over Under', leagueId: 'tgifbl', leagueCode: 'TGIFBL', season: 'Season 1' },
  { name: 'Full Time Ballers', leagueId: 'tgifbl', leagueCode: 'TGIFBL', season: 'Season 1' },
  { name: 'DBRKDZ', leagueId: 'tgifbl', leagueCode: 'TGIFBL', season: 'Season 1' },
  { name: 'BLBG', leagueId: 'tgifbl', leagueCode: 'TGIFBL', season: 'Season 1' },
  { name: 'Mantiku', leagueId: 'tgifbl', leagueCode: 'TGIFBL', season: 'Season 1' },
  { name: 'Fourteen Ounce', leagueId: 'tgifbl', leagueCode: 'TGIFBL', season: 'Season 1' },
  { name: 'Ball is Life', leagueId: 'tgifbl', leagueCode: 'TGIFBL', season: 'Season 1' },
  { name: 'JC Trans Jrs', leagueId: 'tgifbl', leagueCode: 'TGIFBL', season: 'Season 1' },
